...
const menuItems = [
  ...
  { icon: Pin, label: "Ideia do dia", path: "/ideia-do-dia" },
  { icon: Flame, label: "Metas mensais", path: "/streaks" },
  { icon: BarChart3, label: "Monitorar", path: "/monitorar" },
  { icon: CalendarHeart, label: "Favoritos", path: "/favoritos" },
];
